...
import { prettyPrint, compact, NodysseusPrettyPrinter } from './nodysseus-pretty-printer';
...
const createDemoGraph = (): Graph => {
  ...
  const sphereGeometry: RefNode = {
    ...
    value: function() { return 'SphereGeometry'; }
  };
  ...
  const basicMaterial: RefNode = {
    id: 'basic-material',
    ref: '@graph.executable',
    value: function() { return 'MeshBasicMaterial'; }
  };
  ...
  const mesh: RefNode = {
    id: 'main-mesh',
    ref: '@graph.executable',
    value: function() { return 'THREE.Mesh'; }
  };
  ...
  const translateX: RefNode = {
    id: 'translate-x',
    ref: '@graph.executable',
    value: function() { return 'translateXObj'; }
  };
  ...
  const edges: Record<string, Edge> = {
    'sphere-radius->sphere-geo': { from: 'sphere-radius', to: 'sphere-geo', as: 'arg0' },
    'material-color->basic-material': { from: 'material-color', to: 'basic-material', as: 'arg0' },
    'sphere-geo->main-mesh': { from: 'sphere-geo', to: 'main-mesh', as: 'arg0' },
    'basic-material->main-mesh': { from: 'basic-material', to: 'main-mesh', as: 'arg1' },
    'main-mesh->translate-x': { from: 'main-mesh', to: 'translate-x', as: 'arg0' },
    'x-offset->translate-x': { from: 'x-offset', to: 'translate-x', as: 'arg1' },
    'anim-frame->translate-x': { from: 'anim-frame', to: 'translate-x', as: 'arg2' }
  };

  const edges_in = {
    'sphere-geo': { 'sphere-radius': edges['sphere-radius->sphere-geo'] },
    'basic-material': { 'material-color': edges['material-color->basic-material'] },
    'main-mesh': { 
  ...
  return {
    ...
    description: 'A green sphere that moves along the X-axis with animation frames',
    out: 'translate-x',
    nodes: {
